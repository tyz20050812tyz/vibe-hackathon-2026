...
export function LibraryContent() {
  ...
  const filteredItems = useMemo(() => items.filter((item) => {
    ...
    if (view === "online") return item.resource.availability === "online";
    if (view === "check_library") return item.resource.availability === "check_library";
    return true;
  }), [items, view]);
  ...
  return <section className="space-y-10">
    ...
    <DiscoveryCard {...discovery} onRetry={() => void loadDiscovery()} />
    <section>
