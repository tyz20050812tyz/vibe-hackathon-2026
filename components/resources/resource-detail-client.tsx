...
function typeLabel(type: GetResourceData["resource"]["type"]) {
  return type === "collection" ? "策展专题" : type === "paper" ? "研究论文" : type === "talk" ? "讲座" : "馆藏图书";
}

function availabilityLabel(availability: GetResourceData["resource"]["availability"]) {
  return availability === "online" ? "可在线阅读" : availability === "available" ? "馆内可读（演示状态）" : availability === "reference_only" ? "仅供参考（演示状态）" : "馆藏待查（演示状态）";
}
